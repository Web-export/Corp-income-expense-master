...
const ExpenseDetailBackground = require('../assets/imgs/bg5.png');
const RegisterBackground = require('../assets/imgs/register-bg.png');
const Pro = require('../assets/imgs/bg.png');
const NowLogo = require('../assets/imgs/now-logo.png');
const iOSLogo = require('../assets/imgs/ios.png');
const androidLogo = require('../assets/imgs/android.png');
const ExpenseDetailPicture = require('../assets/imgs/profile-img.jpg');
...
const CorpBackround = require('../assets/imgs/project6.jpg');
...
export default {
  Onboarding,
  Logo,
  ExpenseDetailBackground,
  ExpenseDetailPicture,
  RegisterBackground,
  CorpBackround,
  Viewed,
  Pro,
